...
four_mean  <- (0.1196977 + 0.0007445*(60) - (0.714) + 0.0158639*(38.366) + 0.0088282*(0) + 0.0027386*(0) + 0.0074891*(0) + 0.0467922*(0) + 0.0099816*(1) - 0.0201190*(0) - 0.0162261*(0) + 0.0204401*(0))/0.0010699
...
benefit <- mean_bid * 150000 # Jamie's version
benefit_1 <- four_mean * 150000 # Alex's version
cost <- 7000000

total_benefit <- benefit_1 - cost
total_benefit
...
# Depends if the benefit is $2.6 mil or $11.6 
...
# copare that with no program and voluntary enrollment
