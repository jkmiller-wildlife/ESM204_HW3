...
data_new<- (whales) %>% 
  mutate(income_value = case_when(income == "poor" ~ 0,
                                 income == "middle" ~ 1,
                                 income == "rich" ~ 2,
                                 income == "very_rich" ~ 3,
...
data_table # Not certain this does what we want it to.
...
# mean_bid = 161.6301 when risk = 60 and categorical age variables are as follows: 
...
150000 * risk_per_whale # from Q.4
```
